...
class TaskService {
        ...
        records: [
          {
            ...
            assignee_c: taskData.assignee || null,
      ...
      if (response.results) {
        ...
        if (successful.length > 0) {
          ...
          return {
            ...
            assignee: createdTask.assignee_c || null,
  ...
  async update(id, updateData) {
    try {
      ...
      if (updateData.assignee !== undefined) updateFields.assignee_c = updateData.assignee;
      ...
      if (response.results) {
        ...
        if (successful.length > 0) {
          ...
          return {
            ...
            assignee: updatedTask.assignee_c || null,
